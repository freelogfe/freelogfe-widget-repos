...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getComicsCover() {
        return window.FreelogApp.QI.fetchPresentablesList({ isOnline: 1, tags: 'cover', isLoadingResourceInfo: 1 })
          .then(res => {
            if(res.errcode === 0) {
              ...
              if(dataList.length !== 0) {
                ...
                return window.FreelogApp.QI.getPresentableResourceUrl(presentableId)
              }else {
