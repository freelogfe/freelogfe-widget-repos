...
```html
<!--在PB中引用-->
<freelog-pagebuild-presentation  class="js-wc-widget" data-widget-src="d2686bda89418e51bae5739a5411f245f0e0d78c"></freelog-pagebuild-presentation>
```
...
window.FreelogApp.QI.requireSubSource('d2686bda89418e51bae5739a5411f245f0e0d78c')
    .then(res => {
        var elem = document.createElement('freelog-pagebuild-presentation')
